# Zee5 Website Clone [LiveTV and Videos pages]

### Welcome to the  LiveTV and Videos page of our ZEE5 clone project. This document outlines the specific features and functionalities implemented for the LiveTV and Videos pages.
---
...
3.  **JavaScript:**
 - JavaScript Libraries Used : Our Zee-5 Clone Website Project relies on several external libraries and dependencies to enhance its functionality and features. Below is a list of these libraries along with their purposes:
4.  **Flickity-v2**
